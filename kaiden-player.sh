...
echo_message() {
	echo "${bldgrn}[kaiden_player.sh]${txtrst} ${grn}$1${txtrst}"
}

echo_error() {
	echo "${bldred}[kaiden_player.sh]${txtrst} ${red}$1${txtrst}"
}
...
reset() {
	...
	db_drop_db "kaiden_player_dev"
	db_drop_db "kaiden_player_test"
	db_create_db "kaiden_player_dev"
	db_create_db "kaiden_player_test"
